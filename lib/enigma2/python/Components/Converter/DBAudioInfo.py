...
class DBAudioInfo(Poll, Converter, object):
    GET_AUDIO_ICON = 0
    GET_AUDIO_CODEC = 1
    ...
    def __init__(self, type):
        ...
        self.codecs = {'01_dolbydigitalplus': ('digital+', 'digitalplus', 'ac3+', 'e-ac-3'), 
           ...
           '12_mpeg': ('mpeg', ), 
           '13_ogg': ('vorbis', 'ogg')}
        self.codec_info = {'dolbydigitalplus': ('51', '20', '71'), 'dolbydigital': ('51', '20', '10', '71'), 
           'wma': ('8', '9')}
        self.type, self.interesting_events = {'AudioIcon': (
                       self.GET_AUDIO_ICON, (iPlayableService.evUpdatedInfo,)), 
           'AudioCodec': (
                        self.GET_AUDIO_CODEC, (iPlayableService.evUpdatedInfo,))}[type]
