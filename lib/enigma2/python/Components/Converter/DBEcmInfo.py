...
# Embedded file name: /usr/lib/enigma2/python/Components/Converter/DinoEcmInfo.py
# Compiled at: 2018-01-17 22:51:28
...
class DBEcmInfo(Poll, Converter, object):
    CAID = 0
    PID = 1
    BETACAS = 2
    IRDCAS = 3
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if type == 'EcmTime':
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        if type == 'IsCrypted':
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            if type == 'ShortInfo':
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                if type == 'EcmInfo' or type == 'Default' or type == '' or type == None or type == '%':
                                                                                                                                                                                                                                    self.type = self.ECMINFO
                                                                                                                                                                                                                                else:
                                                                                                                                                                                                                                    self.type = self.FORMAT
                                                                                                                                                                                                                                    self.sfmt = type[:]
        self.CaidsDecoded = {'00': 'Unknown', '10': 'Tandberg', 
           '26': 'Biss/EBU', 
           '01': 'Seca/Mediaguard', 
           '06': 'Irdeto', 
           '17': 'Betacrypt', 
        ...
        if fileExists('/etc/init.d/softcam') and not fileExists('/etc/image-version') or fileExists('/etc/init.d/cardserver') and not fileExists('/etc/image-version'):
            ...
            if serlist is None:
                ...
                if camdlist is None:
                    ...
                    if serlist is None and camdlist is None:
                        serlist = ''
                        camdlist = ''
    ...
    def CaidInfo(self):
        ...
        if caids:
            ...
            if config.osd.language.value == 'el_GR':
                caidlist = '\xce\xa3\xcf\x85\xcf\x83\xcf\x84\xce\xae\xce\xbc\xce\xb1\xcf\x84\xce\xb1 \xce\xba\xcf\x89\xce\xb4\xce\xb9\xce\xba\xce\xbf\xcf\x80\xce\xbf\xce\xaf\xce\xb7\xcf\x83\xce\xb7\xcf\x82: ' + caidlist
            else:
                caidlist = 'Coding systems: ' + caidlist
            return caid
        if not caids:
            if config.osd.language.value == 'el_GR':
                return '\xce\xa7\xcf\x89\xcf\x81\xce\xaf\xcf\x82 \xce\xba\xcf\x89\xce\xb4\xce\xb9\xce\xba\xce\xbf\xcf\x80\xce\xbf\xce\xaf\xce\xb7\xcf\x83\xce\xb7 \xce\xae \xce\xb1\xce\xbd\xce\xb1\xce\xb3\xce\xbd\xcf\x89\xcf\x81\xce\xb9\xcf\x83\xcf\x84\xce\xb9\xce\xba\xcf\x8c'
            return 'FTA'
                                            ...
                                            if item[0] == 'from':
                                                ...
                                                if item[0] == 'system':
                                                    ...
                                                    if item[0] == 'provider':
                                                        ...
                                                        if item[0][:2] == 'cw' or item[0] == 'ChID' or item[0] == 'Service':
                                                            pass
                                                        else:
                                                            if item[0] == 'source':
