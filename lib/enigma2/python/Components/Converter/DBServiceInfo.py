...
class DBServiceInfo(Poll, Converter, object):
	apid = 0
	vpid = 1
	sid = 2
	onid = 3
	...
	def getText(self):
		...
		self.stream['vtype'] = ("MPEG2", "H.264", "MPEG1", "MPEG4-II", "VC1", "VC1-SM", "HEVC","WEBM","TS", "")[info.getInfo(iServiceInformation.sVideoType)]

		# print "[iFlatServiceInfoEX, video type : ", info.getInfo(iServiceInformation.sVideoType), self.stream['vtype']
		
		self.stream['avtype'] = ("MPEG2/", "H.264/", "MPEG1/", "MPEG4-II/", "VC1/", "VC1-SM/", "HEVC/","WEBM/","TS/","")[info.getInfo(iServiceInformation.sVideoType)] + self.stream['atype']
